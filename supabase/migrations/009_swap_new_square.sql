-- Migration 009: Add p_new_square parameter to swap_card_square RPC
-- When provided, the caller's pre-selected square is used instead of random generation.
...
BEGIN
  ...
  -- Replace the square in the jsonb array
